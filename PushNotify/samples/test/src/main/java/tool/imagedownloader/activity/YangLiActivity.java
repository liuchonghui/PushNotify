...
import tool.imagedownloader.fragment.FeiDianFragment;
import tool.imagedownloader.fragment.YongLiFragment;
import tool.imagedownloader.test.R;

public class YangLiActivity extends BaseFragmentActivity {
    protected YongLiFragment mFragment;
